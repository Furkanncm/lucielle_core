...
class LuciThemeDark extends LuciTheme {
  /// Optional [ColorScheme] to customize the theme colors.
  /// If not provided, defaults to [ColorScheme.dark()].
  ...
  /// Creates a [LuciThemeDark] instance.
  ///
  /// The [colorScheme] parameter can be optionally passed to override default dark colors.
  LuciThemeDark(
    this.themeData,
    this.appBarTheme,
    this.textTheme,
  ...
  /// If [colorScheme] is not set, returns [ColorScheme.dark()].
  ColorScheme get _colorScheme => colorScheme ?? const ColorScheme.dark();

  /// Builds the complete [ThemeData] for the dark mode.
  ///
